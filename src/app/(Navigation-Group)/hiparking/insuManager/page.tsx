...
import AlarmIcon from "../../../../../public/images/icon/alarm-icon.png";
import CheckChargeIcon from "../../../../../public/images/icon/checckCharge-icon.png";
          ...
          return (
            ...
            >
              <div className="mb-5 flex flex-col items-start justify-between gap-2 px-4 pt-5 sm:flex-row sm:items-center sm:px-7">
                ...
                <div
                  className={
                    "flex flex-col items-end space-x-4 self-end sm:self-auto md:flex-row lg:items-center"
                  }
                >
                  {/* 만료 예정 경고 섹션 */}
                  {showWarning && (
                    <div className="mb-2 flex items-center space-x-2 lg:mb-0">
                      <div
                        className={
